          ...
          content: (
            <div>
              ...
              <div>
                ...
                <p>When it is ready, you can review the results at <a href={`https://predictio.ca/explore/biomarker/result/${res.data.analysis_id}`}>https://predictio.ca/explore/biomarker/result/{res.data.analysis_id}</a>.</p>
